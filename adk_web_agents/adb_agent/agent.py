"""ADK Web wrapper for the real adb_agent package."""
...
PACKAGE_ROOT = PROJECT_ROOT / "adb_agent"
PACKAGE_ALIAS = "adk_web_real_adb_agent"
...
def _load_package_alias():
    ...
    if spec is None or spec.loader is None:
        raise RuntimeError("Failed to create import spec for adb_agent.")
